...
LDFLAGS = -z max-page-size=4096 -T linker.ld -nostdlib --oformat binary
...
test: build
	...
	qemu-system-riscv64 -machine virt -m 128M -bios $(BIN_DIR)/$(PROJECT_NAME) -nographic -serial mon:stdio
